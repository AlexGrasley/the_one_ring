              ...
              Column(
                ...
                children: [
                  Padding(
                      ...
                      child:
                      DiamondShape(character.load.toString(), "Load", labelPosition: LabelPosition.topRight, size: 50,drawSecondLine: false)
                  ),
                  Padding(
                      padding: const EdgeInsets.fromLTRB(0,8,0,8),
                      child:
                      DiamondShape(character.fatigue.toString(), "Fatigue", labelPosition: LabelPosition.bottomRight, size: 50,drawSecondLine: false)
                  ),
                ],
              )
