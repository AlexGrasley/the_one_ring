              ...
              Column(
                ...
                children: [
                  Padding(
                      ...
                      child:
                      DiamondShape(character.shadow.toString(), "Shadow", labelPosition: LabelPosition.topRight, size: 50,drawSecondLine: false)
                  ),
                  Padding(
                      padding: const EdgeInsets.fromLTRB(0,8,0,8),
                      child:
                      DiamondShape(character.shadowScars.toString(), "Sh. Scars", labelPosition: LabelPosition.bottomRight, size: 50,drawSecondLine: false)
                  ),
                ],
              )
