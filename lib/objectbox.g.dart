...
final _entities = <ModelEntity>[
  ...
  ModelEntity(
      ...
      lastPropertyId: const IdUid(3, 562987166547644492),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
  ...
  final bindings = <Type, EntityDefinition>{
    Armour: EntityDefinition<Armour>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = Armour(nameParam,
              id: idParam, rating: ratingParam, note: noteParam);
    ...
    Character: EntityDefinition<Character>(
        ...
        objectToFB: (Character object, fb.Builder fbb) {
          ...
          final culturalBlessingOffset =
              fbb.writeString(object.culturalBlessing);
          ...
          final distinctiveFeaturesOffset =
              fbb.writeString(object.distinctiveFeatures);
    ...
    CombatProficiencies: EntityDefinition<CombatProficiencies>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final idParam =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          final proficiencyParam =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 6, 0);
          final object = CombatProficiencies(nameParam,
              id: idParam, proficiency: proficiencyParam);
    ...
    Virtue: EntityDefinition<Virtue>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final noteParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 8, '');
          final object = Virtue(id: idParam, name: nameParam, note: noteParam);
...
class Armour_ {
  /// see [Armour.id]
  static final id = QueryIntegerProperty<Armour>(_entities[0].properties[0]);

  /// see [Armour.rating]
  static final rating =
      QueryIntegerProperty<Armour>(_entities[0].properties[1]);

  /// see [Armour.name]
  static final name = QueryStringProperty<Armour>(_entities[0].properties[2]);
...
class Character_ {
  /// see [Character.id]
  static final id = QueryIntegerProperty<Character>(_entities[1].properties[0]);

  /// see [Character.name]
  static final name =
      QueryStringProperty<Character>(_entities[1].properties[1]);

  /// see [Character.heroicCulture]
  static final heroicCulture =
      QueryStringProperty<Character>(_entities[1].properties[2]);

  /// see [Character.culturalBlessing]
  static final culturalBlessing =
      QueryStringProperty<Character>(_entities[1].properties[3]);

  /// see [Character.patron]
  static final patron =
      QueryStringProperty<Character>(_entities[1].properties[4]);

  /// see [Character.calling]
  static final calling =
      QueryStringProperty<Character>(_entities[1].properties[5]);

  /// see [Character.shadowPath]
  static final shadowPath =
      QueryStringProperty<Character>(_entities[1].properties[6]);

  /// see [Character.distinctiveFeatures]
  static final distinctiveFeatures =
      QueryStringProperty<Character>(_entities[1].properties[7]);

  /// see [Character.flaws]
  static final flaws =
      QueryStringProperty<Character>(_entities[1].properties[8]);

  /// see [Character.travellingGear]
  static final travellingGear =
      QueryStringProperty<Character>(_entities[1].properties[9]);

  /// see [Character.age]
  static final age =
      QueryIntegerProperty<Character>(_entities[1].properties[10]);

  /// see [Character.treasure]
  static final treasure =
      QueryIntegerProperty<Character>(_entities[1].properties[11]);

  /// see [Character.strengthTn]
  static final strengthTn =
      QueryIntegerProperty<Character>(_entities[1].properties[12]);

  /// see [Character.strengthRating]
  static final strengthRating =
      QueryIntegerProperty<Character>(_entities[1].properties[13]);

  /// see [Character.endurance]
  static final endurance =
      QueryIntegerProperty<Character>(_entities[1].properties[14]);

  /// see [Character.heartTn]
  static final heartTn =
      QueryIntegerProperty<Character>(_entities[1].properties[15]);

  /// see [Character.heartRating]
  static final heartRating =
      QueryIntegerProperty<Character>(_entities[1].properties[16]);

  /// see [Character.hope]
  static final hope =
      QueryIntegerProperty<Character>(_entities[1].properties[17]);

  /// see [Character.witsTn]
  static final witsTn =
      QueryIntegerProperty<Character>(_entities[1].properties[18]);

  /// see [Character.witsRating]
  static final witsRating =
      QueryIntegerProperty<Character>(_entities[1].properties[19]);

  /// see [Character.parry]
  static final parry =
      QueryIntegerProperty<Character>(_entities[1].properties[20]);

  /// see [Character.adventurePoint]
  static final adventurePoint =
      QueryIntegerProperty<Character>(_entities[1].properties[21]);

  /// see [Character.skillPoints]
  static final skillPoints =
      QueryIntegerProperty<Character>(_entities[1].properties[22]);

  /// see [Character.fellowshipScore]
  static final fellowshipScore =
      QueryIntegerProperty<Character>(_entities[1].properties[23]);

  /// see [Character.currentEndurance]
  static final currentEndurance =
      QueryIntegerProperty<Character>(_entities[1].properties[24]);

  /// see [Character.load]
  static final load =
      QueryIntegerProperty<Character>(_entities[1].properties[25]);

  /// see [Character.fatigue]
  static final fatigue =
      QueryIntegerProperty<Character>(_entities[1].properties[26]);

  /// see [Character.currentHope]
  static final currentHope =
      QueryIntegerProperty<Character>(_entities[1].properties[27]);

  /// see [Character.shadow]
  static final shadow =
      QueryIntegerProperty<Character>(_entities[1].properties[28]);

  /// see [Character.shadowScars]
  static final shadowScars =
      QueryIntegerProperty<Character>(_entities[1].properties[29]);

  /// see [Character.valour]
  static final valour =
      QueryIntegerProperty<Character>(_entities[1].properties[30]);

  /// see [Character.wisdom]
  static final wisdom =
      QueryIntegerProperty<Character>(_entities[1].properties[31]);

  /// see [Character.weary]
  static final weary =
      QueryBooleanProperty<Character>(_entities[1].properties[32]);

  /// see [Character.miserable]
  static final miserable =
      QueryBooleanProperty<Character>(_entities[1].properties[33]);
...
class CombatProficiencies_ {
  /// see [CombatProficiencies.id]
  static final id =
      QueryIntegerProperty<CombatProficiencies>(_entities[2].properties[0]);

  /// see [CombatProficiencies.proficiency]
  static final proficiency =
      QueryIntegerProperty<CombatProficiencies>(_entities[2].properties[1]);

  /// see [CombatProficiencies.name]
  static final name =
      QueryStringProperty<CombatProficiencies>(_entities[2].properties[2]);
}

/// [Reward] entity fields to define ObjectBox queries.
class Reward_ {
  /// see [Reward.id]
  static final id = QueryIntegerProperty<Reward>(_entities[3].properties[0]);

  /// see [Reward.name]
  static final name = QueryStringProperty<Reward>(_entities[3].properties[1]);

  /// see [Reward.note]
  static final note = QueryStringProperty<Reward>(_entities[3].properties[2]);

  /// see [Reward.armourId]
  static final armourId =
      QueryIntegerProperty<Reward>(_entities[3].properties[3]);

  /// see [Reward.weaponId]
  static final weaponId =
      QueryIntegerProperty<Reward>(_entities[3].properties[4]);
}

/// [Skill] entity fields to define ObjectBox queries.
class Skill_ {
  /// see [Skill.id]
  static final id = QueryIntegerProperty<Skill>(_entities[4].properties[0]);

  /// see [Skill.pips]
  static final pips = QueryIntegerProperty<Skill>(_entities[4].properties[1]);

  /// see [Skill.name]
  static final name = QueryStringProperty<Skill>(_entities[4].properties[2]);
...
class Virtue_ {
  /// see [Virtue.id]
  static final id = QueryIntegerProperty<Virtue>(_entities[5].properties[0]);

  /// see [Virtue.name]
  static final name = QueryStringProperty<Virtue>(_entities[5].properties[1]);
...
class Weapon_ {
  /// see [Weapon.id]
  static final id = QueryIntegerProperty<Weapon>(_entities[6].properties[0]);

  /// see [Weapon.damage]
  static final damage =
      QueryIntegerProperty<Weapon>(_entities[6].properties[1]);

  /// see [Weapon.injury]
  static final injury =
      QueryIntegerProperty<Weapon>(_entities[6].properties[2]);

  /// see [Weapon.name]
  static final name = QueryStringProperty<Weapon>(_entities[6].properties[3]);
